                            ...
                            <form>
                                ...
                                <div className="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                                    <div className="w-full  mb-4 mt-6">
                                        ...
                                        <input type="text"
                                            className="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800" value={userData.user.full_Name}
                                ...
                                <div className="w-full mb-4">
                                        ...
                                        <input type="email"
                                            className="p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800" value={userData.user.email}
                                            placeholder="Email"/>
                                    </div>
                                    <div className="w-full">
                                        <h3 className="dark:text-gray-300">MobileNo</h3>
                                        <input type="number" value={userData.user.phone_number}
